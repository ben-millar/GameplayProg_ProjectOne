...
c2AABB GameObject::getBounds()
{
	...
	sf::Vector2f minPixPos{ CoordinateConverter::GL_TO_PIXEL({ m_offset.x, GROUND_POS - ASPECT_RATIO }) };
	sf::Vector2f maxPixPos{ CoordinateConverter::GL_TO_PIXEL({ m_offset.x + 2, GROUND_POS - 6.0f}) };
